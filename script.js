...
'.card, .experience-item, .cert-card, .award-card, .opportunity-
card, .value-item'
);
animatedElements.forEach(element => {
element.style.opacity = '0';
element.style.transform = 'translateY(20px)';
element.style.transition = 'opacity 0.6s ease, transform 0.6s
ease';
});
...
// CONSOLE MESSAGE
// ================================
console.log('%c Hello! Thanks for visiting my portfolio!', 'color:
#2563eb; font-size: 16px; font-weight: bold;');
console.log('%cIf you\'re interested in working together, let\'s
connect!', 'color: #64748b; font-size: 14px;');
console.log('%c pranavkarnik6@gmail.com', 'color: #0ea5e9; font-size:
14px;');
